...
export const stockApi = {
  ...
  watchlistRemove: (id: number, stockCode?: string) => callApi('stock', 'watchlist_remove', { id, stockCode }),
  watchlistUpdate: (params: { id: number; name?: string; group?: string; sortOrder?: number; remark?: string }) => callApi('stock', 'watchlist_update', params),
