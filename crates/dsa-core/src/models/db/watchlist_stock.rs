...
pub struct WatchlistStock {
    ...
    #[field(required = true, rename = "stock_code", length = 16, comment = "股票代码")]
    pub stock_code: String,

    #[field(rename = "stock_name", length = 64, default_value = "''", comment = "股票名称")]
    pub stock_name: String,

    #[field(rename = "market", length = 8, default_value = "'cn'", comment = "市场")]
    pub market: String,

    #[field(rename = "group_name", length = 32, default_value = "'default'", comment = "分组")]
    pub group_name: String,

    #[field(default_value = "1", comment = "排序权重")]
    pub sort_order: i32,
