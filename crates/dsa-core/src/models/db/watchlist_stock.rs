...
#[table(name = "watchlist_stocks", comment = "自选股列表", primary = "identity")]
pub struct WatchlistStock {
    #[field(primary = true, increment = 1)]
    pub id: i64,

    #[field(required = true, rename = "stockCode", length = 16, comment = "股票代码")]
    pub stock_code: String,

    #[field(rename = "stockName", length = 64, default_value = "''", comment = "股票名称")]
    pub stock_name: String,

    #[field(rename = "market", length = 8, default_value = "'cn'", comment = "市场")]
    pub market: String,

    #[field(rename = "groupName", length = 32, default_value = "'default'", comment = "分组")]
    pub group_name: String,

    #[field(rename = "sortOrder", default_value = "1", comment = "排序权重")]
    pub sort_order: i32,
