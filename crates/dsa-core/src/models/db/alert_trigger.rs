...
pub struct AlertTrigger {
    ...
    #[field(required = true, rename = "ruleId", comment = "关联规则ID")]
    pub rule_id: i64,

    #[field(required = true, rename = "stockCode", comment = "股票代码")]
    pub stock_code: String,

    #[field(rename = "triggerType", comment = "触发类型")]
    pub trigger_type: String,

    #[field(rename = "triggerValue", comment = "触发值")]
    pub trigger_value: f64,

    #[field(rename = "conditionSnapshot", comment = "条件快照JSON")]
    ...
    #[field(rename = "observedValue", default_value = "0", comment = "观测值")]
    ...
    #[field(rename = "dataSource", length = 64, default_value = "''", comment = "数据源")]
    pub data_source: String,

    #[field(rename = "dataTimestamp", comment = "数据时间戳")]
    pub data_timestamp: Option<chrono::NaiveDateTime>,

    #[field(rename = "triggerStatus", length = 16, default_value = "'fired'", comment = "触发状态")]
