...
#[table(
    name = "agent_provider_turns",
    comment = "Agent Provider协议追踪",
    primary = "identity"
)]
pub struct AgentProviderTurn {
    ...
    #[field(
        rename = "anchor_assistant_message_id",
        default_value = "0",
        comment = "锚点助手消息ID"
    )]
    ...
    #[field(
        rename = "contains_thinking_blocks",
        default_value = "0",
        comment = "包含thinking块"
    )]
