...
pub struct PortfolioFxRate {
    ...
    #[field(rename = "from_currency", required = true, comment = "源币种")]
    pub from_currency: String,

    #[field(rename = "to_currency", required = true, comment = "目标币种")]
    pub to_currency: String,

    #[field(rename = "rate_date", required = true, comment = "汇率日期")]
    ...
    #[field(rename = "is_stale", default_value = "0", comment = "是否过期")]
    pub is_stale: i8,
