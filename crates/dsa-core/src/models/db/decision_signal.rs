...
pub struct DecisionSignal {
    ...
    #[field(rename = "source_agent", length = 64, default_value = "''", comment = "来源Agent")]
    pub source_agent: String,

    #[field(rename = "source_report_id", default_value = "0", comment = "来源报告ID")]
    pub source_report_id: i32,

    #[field(rename = "trace_id", length = 64, default_value = "''", comment = "追踪ID")]
    pub trace_id: String,

    #[field(rename = "market_phase", length = 24, default_value = "''", comment = "市场阶段")]
    pub market_phase: String,

    #[field(rename = "trigger_source", length = 64, default_value = "''", comment = "触发源")]
    ...
    #[field(rename = "watch_conditions", default_value = "''", comment = "观察条件")]
    ...
    #[field(rename = "catalyst_summary", default_value = "''", comment = "催化摘要")]
    pub catalyst_summary: String,

    #[field(rename = "evidence_json", default_value = "''", comment = "证据JSON")]
    pub evidence_json: String,

    #[field(rename = "plan_quality_label", length = 16, default_value = "''", comment = "计划质量标签")]
    pub plan_quality_label: String,

    #[field(rename = "signal_status", length = 16, default_value = "'active'", comment = "信号状态")]
